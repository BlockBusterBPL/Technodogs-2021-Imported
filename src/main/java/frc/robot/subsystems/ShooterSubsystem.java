...
private NetworkTableEntry calcDist = subsystemShuffleboardTab.add("Calc Dist", 0)
  ...
  public void shootAtVelocityButWorking() {
  ...
  public double getDistance() {
    ...
    //get area from limelight
    double area = getArea();
    // put raw value on shuffleboard
    llArea.setDouble(area);
    // apply generalized equation calculated in spreadsheet
    double distance = (area / 2); //TODO: figure out this equation
    // put the calculated height on shuffleboard
